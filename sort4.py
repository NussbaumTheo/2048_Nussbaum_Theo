...
# on propose de tester des valeurs avec de plus en plus de mouvement
  # 1,2,3,4 : rien ne bouge [1,2,3,4,0] juste
  # 1,1,2,3 : rien ne bouge [1,1,2,3,0] juste
  # 1,2,4,3 : résultat attendu [1,2,3,4,1] juste
  # 1,4,3,2 : résultat attendu [1,2,3,4,3] juste
  # 4,3,1,2 : résultat attendu [1,2,3,4,5] juste
  # 4,3,2,1 : résultat attendu [1,2,3,4,6] pas juste
